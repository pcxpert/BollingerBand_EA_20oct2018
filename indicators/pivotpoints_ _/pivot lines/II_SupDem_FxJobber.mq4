...
extern color color_sup_strong = PaleVioletRed;
extern color color_sup_weak = LightPink;
extern color color_sup_retouch = Pink;
extern color color_dem_strong = SeaGreen;
extern color color_dem_weak = DarkSeaGreen;
extern color color_dem_retouch = DarkSeaGreen;
...
string l_hud,l_zone;
int HUD_x;
string font_HUD = "Calibri";
int font_HUD_size = 9;
string font_HUD_price = "Calibri";
int font_HUD_price_size = 9;
int arrow_UP = 0x70;
int arrow_DN = 0x71;
string font_arrow = "WingDings 3";
int font_arrow_size = 30;
...
/*void DoLogo(){
   ...
   int size[3] = {25,10,10};
   int pos_x[3] = {47,19,17};
   int pos_y[3] = {10,25,15};
